<div class="flex items-center justify-center h-screen">
    ...
    <div>
        <div class="flex flex-col items-center space-y-2">
            ...
            <a href="{{ route('answers.create', $this->surveyId) }}" class="inline-flex items-center px-4 py-2 text-white bg-indigo-600 border border-indigo-600 rounded rounded-full hover:bg-indigo-700 focus:outline-none focus:ring">
